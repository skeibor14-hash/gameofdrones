	...
	public class Pagina{
		...
		public static string superior( HttpContext context, string titulo, bool cache, bool robots, bool csp ){
			...
			/*Obtener Valores base*/
				...
				string archivo_xhr		= _sistema_.Lector_ENV.obtener("archivo_xhr");
				...
				string sanitizador		= _sistema_.Lector_ENV.obtener("archivo_sanitizador");
			...
			/*Realizar remplazos*/
				...
				contenido = contenido.Replace("{$_archivo_xhr_$}",				archivo_xhr								);
				contenido = contenido.Replace("{$_sanitizador_js_$}",			sanitizador								);
			/**/
			/*Cabezeras*/
				...
				_sistema_.Posts.cabezera_csrf( context );
			/**/
			/*Aplicar cabezeras*/
