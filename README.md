...
6. Una ves compilado el proyecto, podemos utilizar el `[exe]` encontrado dentro de la carpeta `[bin]` mencionada anteriormente y el cual nos servirá para ejecutar la aplicación sin requerir compilar de nuevo.
