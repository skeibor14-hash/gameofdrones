		...
		public static string opciones(){
			...
			/*Verificar*/
				_sistema_.Modelos.verificar_tabla(
					""
					,modelos.Juegos_Estados.Tabla_nombre
					,modelos.Juegos_Estados.Tabla_estructura
					,modelos.Juegos_Estados.Campos_insertables
					,modelos.Juegos_Estados.Campo_creado
					,modelos.Juegos_Estados.Datos_migrables
				);
			/**/
			/*Envio*/
				return _sistema_.Modelos.opciones( "", modelos.Juegos_Estados.Tabla_nombre );
			/**/
		}
	}
}