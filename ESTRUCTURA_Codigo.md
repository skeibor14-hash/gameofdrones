...
9. ./arhivos_locales
	*   Carpeta con serie de archivos usados por el sistema, especialmente para vistas y elementos visuales.
	*   Esta carpeta será copiada a bin/debug/net10.0/ o lo que se haya configurado en el env.txt